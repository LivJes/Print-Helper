...
class MainApp(App):
    def build(self):
        ...
        lengthLabel = Label(text="Dĺžka (m)", font_size=20, halign="left")
        self.length = TextInput(text="0", multiline=False, readonly=False, halign="right", font_size=40)
        dimensionLayout = BoxLayout(orientation="horizontal", padding = [0, 5], spacing = 20)
        dimensionsLabel = Label(text="Výška etikety (mm)", font_size=20, halign="left")
        self.dimensions = TextInput(text="0", multiline=False, readonly=False, halign="right", font_size=40)
        quantityLayout = BoxLayout(orientation="horizontal", padding = [0, 5], spacing = 20)
        quantityLabel = Label(text="Počet etikiet", font_size=20, halign="left")
        self.quantity = TextInput(text="0", multiline=False, readonly=False, halign="right", font_size=40)
        productionLayout = BoxLayout(orientation="horizontal", padding = [0, 5], spacing = 20)
        productionLabel = Label(text="Produkcia", font_size=20, halign="left")
        self.production = TextInput(text="1", multiline=False, readonly=False, halign="right", font_size=40)
        ...
        equalsButton = Button(text="=", pos_hint={"center_x": 0.5, "center_y": 0.5}, font_size=40)
        equalsButton.bind(on_press=self.onButtonClick)
        buttonBox.add_widget(equalsButton)
        zeroButton = Button(text="C", pos_hint={"center_x": 0.5, "center_y": 0.5}, font_size=40)
